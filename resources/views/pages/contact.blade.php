      ...
      <div class="row main_card_box mt-4">
          <h2 class="mb-2"><u>Contact</u></h2>
            <div class="col-12 col-md-6 mt-1 row">
              ...
              <div class="col-12">
                <h5 class="mb-0"><strong>Buy me a coffee</strong></h5>
                <a href="https://buymeacoffee.com/vongsakorntie" class="text-decoration-none text-dark fs-6"><u>buymeacoffee.com/vongsakorntie</u></a><br>
              </div>
            </div>
